            ...
            <div class="mx-auto px-4 sm:px-8 text-center">
                <div class="mt-4">
                    <a href="/section/create"
                       class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-black uppercase
                       transition bg-transparent border-2 border-black rounded-full ripple hover:bg-gray-100
                       focus:outline-none">
                        Add new Section
                    </a>
                </div>
